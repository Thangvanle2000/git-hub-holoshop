                ...
                <main>
                    <div class="container-fluid px-4">
						...
						<form action="add-product.php">
						  <h5>Computer profile</h5> <button type="submit" class="bg-primary text-light">Add Computer Profile</button>
						</form>
					  </div>
					  <?php 
					  ...
					  <table class="table-profile" id="datatable" cellspacing= "0" width="100%">  
						...
						<tr>
							...
							<td>
								...
								<button type="submit" name="delete_computer" class="btn btn-danger">Delete</button>
								</form> 
								</td>
					  <?php	
