                ...
                <main>
                    <div class="container-fluid px-4">
                      ...
                      foreach($query_run as $row){
						...
						<input type="text" name="edit_category" value="<?php echo $row['category'] ?>" class="form-control">
						</div>
						...
						<div class="form-group">
							<label>Storage:</label>
						<input type="text" name="edit_storage" value="<?php echo $row['storage'] ?>" class="form-control">
						</div>
						<div class="form-group">
							<label>RAM:</label>
